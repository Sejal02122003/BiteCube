...
export async function writeDeliveryLocation({
  ...
  try {
    ...
    // If Firebase RTDB write rules block direct client-side updates (e.g. permission_denied),
    // handle gracefully as backend WebSockets & HTTP APIs handle real-time location sync.
    return false;
  }
}
